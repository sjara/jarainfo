...
newSession = {'subject':subject, 'date':'20260514', 'session': '000',
              'fps': 9.96, 'magnification': 1.7, 'depth': 181.89, 'angle': 34.48,
              'laserPower': 34, 'wavelength': 920, 'nFrames': 6115, 
              'brainArea': 'A1', 'sessionLabel': 'tuningFreq', 
              'pmt': [0,1], 'paradigm':'am_tuning'}
sessions.append(newSession)

newSession = {'subject':subject, 'date':'20260514', 'session': '001',
              'fps': 9.96, 'magnification': 1.7, 'depth': 181.89, 'angle': 34.48,
...
newSession = {'subject':subject, 'date':'20260514', 'session': '002',
              'fps': 9.96, 'magnification': 1.7, 'depth': 181.89, 'angle': 34.48,
              'laserPower': 34, 'wavelength': 920, 'nFrames': 16000, 
              'brainArea': 'A1', 'sessionLabel': 'natSounds', 
              'pmt': [0,1], 'paradigm':'natural_sound_detection'}
sessions.append(newSession)

newSession = {'subject':subject, 'date':'20260514', 'session': '003',
              'fps': 9.96, 'magnification': 1.7, 'depth': 496.12, 'angle': 34.48,
              'laserPower': 51, 'wavelength': 920, 'nFrames': 6115, 
              'brainArea': 'A1', 'sessionLabel': 'tuningFreq', 
              'pmt': [0,1], 'paradigm':'am_tuning'}
sessions.append(newSession)

newSession = {'subject':subject, 'date':'20260514', 'session': '004',
              'fps': 9.96, 'magnification': 1.7, 'depth': 496.12, 'angle': 34.48,
...
newSession = {'subject':subject, 'date':'20260514', 'session': '005',
              'fps': 9.96, 'magnification': 1.7, 'depth': 496.12, 'angle': 34.48,
...
newSession = {'subject':subject, 'date':'20260514', 'session': '006',
              'fps': 9.96, 'magnification': 1.7, 'depth': 206.3, 'angle': 34.48,
              'laserPower': 39, 'wavelength': 920, 'nFrames': 6115, 
