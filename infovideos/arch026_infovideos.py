...
videos.add_session('2025-10-28', 'optoTuningAM',
                   'arch026_am_tuning_curve_20251028_03.mkv',
                   'arch026_am_tuning_curve_20251028c.h5', cameraParams)
...
#session with 640 trials
videos.add_session('2025-10-28', 'optoTuningFreq',
                   'arch026_am_tuning_curve_20251028_02.mkv',
                   'arch026_am_tuning_curve_20251028b.h5', cameraParams)


#session with 160 trials
videos.add_session('2025-10-24', 'optoNaturalInstances',
                  ' arch026_natural_sound_detection_20251028_04.mkv'
                   'arch026_natural_sound_detection_20251028b.h5', cameraParams)
