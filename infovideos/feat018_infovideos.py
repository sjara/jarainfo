...
videos.add_session('2024-06-10', 'pureTones',
                   'feat018_am_tuning_curve_20240610_01.mkv',
                   'feat018_am_tuning_curve_20240610a.h5', cameraParams) 
                   
                   
videos.add_session('2024-06-10', 'naturalSounds',
                   'feat018_natural_sound_detection_20240610_01.mkv',
                   'feat018_natural_sound_detection_20240610a.h5', cameraParams) 
                   
videos.add_session('2024-06-10', 'AM',
                   'feat018_am_tuning_curve_20240610_02.mkv',
                   'feat018_am_tuning_curve_20240610b.h5', cameraParams) 
                   
# 2024-06-11

videos.add_session('2024-06-11', 'pureTones',
                   'feat018_am_tuning_curve_20240611_01.mkv',
                   'feat018_am_tuning_curve_20240611a.h5', cameraParams) 
                   
                   
videos.add_session('2024-06-11', 'naturalSounds',
                   'feat018_natural_sound_detection_20240611_01.mkv',
                   'feat018_natural_sound_detection_20240611a.h5', cameraParams) 
                   
videos.add_session('2024-06-11', 'AM',
                   'feat018_am_tuning_curve_20240611_02.mkv',
                   'feat018_am_tuning_curve_20240611b.h5', cameraParams) 
