...
exp0 = celldatabase.Experiment(subject, '2022-03-23', brainArea='AC_right', probe = 'NPv1-4542', recordingTrack='anteriorlateral_DiI', info=['facesMedial', 'soundLeft']) #reference = tip
...
exp1 = celldatabase.Experiment(subject, '2022-03-24', brainArea='AC_right', probe = 'NPv1-4542', recordingTrack='anteriormedial_DiD', info=['facesMedial', 'soundLeft']) #reference = tip
...
exp2 = celldatabase.Experiment(subject, '2022-03-25', brainArea='AC_right', probe = 'NPv1-4542', recordingTrack='caudomedial_DiI', info=['facesMedial', 'soundLeft']) #reference = tip
