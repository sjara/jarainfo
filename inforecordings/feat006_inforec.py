...
exp0 = celldatabase.Experiment(subject, '2022-02-21', brainArea='AC_right', probe = 'NPv1-8131', recordingTrack='caudomedialDiI', info=['facesMedial', 'soundLeft']) #reference = external
...
exp1 = celldatabase.Experiment(subject, '2022-02-22', brainArea='AC_right', probe = 'NPv1-8131', recordingTrack='middlemedialDiD', info=['facesMedial', 'soundLeft']) #reference = external
...
#exp2 = celldatabase.Experiment(subject, '2022-02-23', brainArea='AC_right', probe = 'NPv1-8131', recordingTrack='DiI', info=['facesMedial', 'soundLeft']) #reference = external
#experiments.append(exp2)
# 13:20 in booth
# 13:30 can't penetrate brain, trying cleaning craniotomy
# 14:40 still couldn't get in brain. cancelled recording

exp3 = celldatabase.Experiment(subject, '2022-02-24', brainArea='AC_left', probe = 'NPv1-8131', recordingTrack='caudomedialDiI', info=['facesMedial', 'soundRight']) #reference = external
...
exp4 = celldatabase.Experiment(subject, '2022-02-25', brainArea='AC_left', probe = 'NPv1-8131', recordingTrack='middlemedialDiD', info=['facesMedial', 'soundRight']) #reference = external
...
exp5 = celldatabase.Experiment(subject, '2022-02-26', brainArea='AC_left', probe = 'NPv1-8131', recordingTrack='anteromedialDiI', info=['facesMedial', 'soundRight']) #reference = external
...
exp6 = celldatabase.Experiment(subject, '2022-02-28', brainArea='AC_left', probe = 'NPv1-8131', recordingTrack='anterolateralDiD', info=['facesMedial', 'soundRight']) #reference = external
...
exp7 = celldatabase.Experiment(subject, '2022-03-01', brainArea='AC_left', probe = 'NPv1-8131', recordingTrack='middlelateralDiI', info=['facesMedial', 'soundRight']) #reference = external
...
exp8 = celldatabase.Experiment(subject, '2022-03-02', brainArea='AC_left', probe = 'NPv1-8131', recordingTrack='caudolateralDiD', info=['facesMedial', 'soundRight']) #reference = external
