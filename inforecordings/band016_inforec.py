...
exp0 = celldatabase.Experiment(subject, '2016-12-11', 'left_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
# exp0.add_site(900, egroups = [2,3,4,6])
# exp0.add_session('14-35-05', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(950, egroups = [2,3,4,5,6])
...
exp1 = celldatabase.Experiment(subject, '2016-12-12', 'right_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
# exp2 = celldatabase.Experiment(subject, '2016-12-22','AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
#
# exp2.add_site(930, egroups = [3,5,7,8])
