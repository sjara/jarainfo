...
#-------------------------------------------------------------------------------------------------------
#We saw from the histology that shank 1 and 2 hit the pStr
...
# Shank 3 Bank A
#exp0.add_session('16-54-44', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp0.add_site(1120) 
# Shank 3 Bank B
#exp0.add_session('16-59-35', 'f', 'tuningFreqLFP', 'am_tuning_curve') #40 trial
...
# Shank 3 Bank A
#exp1.add_session('13-06-24', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp1.add_site(820)
# Shank 3 Bank B
#exp1.add_session('13-08-47', 'f', 'tuningFreqLFP', 'am_tuning_curve') #40 trial
#-------------------------------------------------------------------------------------------------------

#-------------------------------------------------------------------------------------------------------
#Did not see this penetration in the histology
...
# Shank 3 Bank A
#exp2.add_session('13-47-59', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp2.add_site(312) #The actual dept is -312
# Shank 3 Bank B
#exp2.add_session('13-50-07', 'f', 'tuningFreqLFP', 'am_tuning_curve') #40 trial
...
#exp3.add_site(3508) 
# Shank 3 Bank A
#exp3.add_session('12-57-41', 'i', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp3.add_site(630) 
# Shank 3 Bank B
#exp3.add_session('12-59-50', 'j', 'tuningFreqLFP', 'am_tuning_curve') #40 trial
#-------------------------------------------------------------------------------------------------------

#-------------------------------------------------------------------------------------------------------
#We saw from the histology that shank 4 hit the pStr 
...
#exp4.add_site(3598) 
# Shank 3 Bank A
#exp4.add_session('16-03-26', 'i', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp4.add_site(720)
# Shank 3 Bank B
#exp4.add_session('16-05-22', 'j', 'tuningFreqLFP', 'am_tuning_curve') #40 trial
