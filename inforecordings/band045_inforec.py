...
exp0 = celldatabase.Experiment(subject, '2018-01-25', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
#
# exp0.add_site(1125, egroups=[2,4,5,6,7,8])
# exp0.add_session('15-14-39', None, 'laserPulse', 'am_tuning_curve')
#
# exp0.add_site(1150, egroups=[2,4,5,6,7,8])
# exp0.add_session('15-18-53', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(1175, egroups=[1,2,4,5,6,7,8])
...
exp1 = celldatabase.Experiment(subject, '2018-01-26', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
exp2 = celldatabase.Experiment(subject, '2018-01-30', 'right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
exp3 = celldatabase.Experiment(subject, '2018-01-31', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
# exp3.add_site(850, egroups=[2,4,5,6])
# exp3.add_session('13-35-26', None, 'laserPulse', 'am_tuning_curve')
#
# exp3.add_site(875, egroups=[2,4,5,6])
...
# exp3.add_site(950, egroups=[2,4,5,6,7,8])
...
exp4 = celldatabase.Experiment(subject, '2018-02-01', 'left_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_right'])
