...
exp0 = celldatabase.Experiment(subject, '2016-08-29', 'right_AC', probe='A4x2-tet', info=['centerDiO','TT1ant','sound_left'])
...
# exp0.add_site(673, egroups=[2,4])
# exp0.add_session('12-24-09', None, 'noisebursts', 'am_tuning_curve')
#
# exp0.add_site(678, egroups=[1,2,4])
...
exp0.add_site(832, egroups = [1,2,4,6])
...
exp0.add_site(884, egroups = [1,2,3,4,6])
...
exp0.add_site(950, egroups = [1,2,3,4,6])
...
exp1 = celldatabase.Experiment(subject, '2016-08-30', 'right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
exp1.add_site(1030, egroups = [2,4,6])
...
# exp1.add_site(1150, egroups=[1,2,3,4,6])
# exp1.add_session('15-01-06', None, 'laserPulse', 'am_tuning_curve')

exp1.add_site(1200, egroups=[1,2,4,5,6])
...
exp2 = celldatabase.Experiment(subject, '2016-08-31', 'right_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
exp2.add_site(1075, egroups=[1,2,3,4,6])
...
# exp2.add_site(1125, egroups=[1,2,3,4,6])
# exp2.add_session('15-03-31', None, 'laserPulse', 'am_tuning_curve')

exp2.add_site(1175, egroups=[1,2,3,4,6])
...
exp3 = celldatabase.Experiment(subject, '2016-09-09', 'left_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
exp3.add_site(1051, egroups = [2,3,4,5,6])
...
exp4 = celldatabase.Experiment(subject, '2016-09-11', 'left_AC', probe='A4x2-tet', info=['medialDiO','TT1ant','sound_left'])
...
# exp4.add_site(1200, egroups = [1,2,3,4,5,6])
# exp4.add_session('13-47-26', None, 'laserPulse', 'am_tuning_curve')
#
# exp4.add_site(1250, egroups = [1,2,3,4,5,6])
# exp4.add_session('13-55-32', None, 'laserPulse', 'am_tuning_curve')

exp4.add_site(1300, egroups = [1,2,3,4,5,6])
