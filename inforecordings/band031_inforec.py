...
exp0 = celldatabase.Experiment(subject, '2017-06-29', 'right_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
exp1 = celldatabase.Experiment(subject, '2017-06-30', 'right_AC', probe='A4x2-tet', info=['lateralDiD','TT1ant','sound_left'])
...
#
# exp1.add_site(1100, egroups=[2,4,6,8])
# exp1.add_session('12-58-37', None, 'laserPulse', 'am_tuning_curve')

exp1.add_site(1120, egroups=[2,4,6,8])
