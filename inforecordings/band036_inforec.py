...
exp0 = celldatabase.Experiment(subject, '2017-09-22', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp1 = celldatabase.Experiment(subject, '2017-09-25', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
exp2 = celldatabase.Experiment(subject, '2017-09-27', 'left_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_right'])
