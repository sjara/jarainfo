...
exp0 = celldatabase.Experiment(subject, '2022-01-11', brainArea='AC_right', probe = 'NPv1-2872', recordingTrack='anteromedialDiD', info=['facesMedial', 'soundLeft']) #reference = tip
