...
exp0 = celldatabase.Experiment(subject, '2017-10-10', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
#
# exp0.add_site(1225, egroups=[1,2,3,4,6,8])
...
exp1 = celldatabase.Experiment(subject, '2017-10-11', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
exp2 = celldatabase.Experiment(subject, '2017-10-12', 'right_AC', probe='A4x2-tet', info=['lateralDiD','TT1ant','sound_left'])
...
exp4 = celldatabase.Experiment(subject, '2017-10-16', 'right_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
#
# exp4.add_site(1190, egroups=[2,4,6,8])
# exp4.add_session('13-16-22', None, 'laserPulse', 'am_tuning_curve')
#
# exp4.add_site(1220, egroups=[2,4,8])
