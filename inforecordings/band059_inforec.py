...
# exp0 = celldatabase.Experiment(subject, '2018-03-08', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
# exp0.add_site(1350, egroups=[2,8])
# exp0.add_session('16-35-39', None, 'noisebursts', 'am_tuning_curve')
#
# exp0.add_site(1400, egroups=[2,8])
# exp0.add_session('16-45-43', None, 'noisebursts', 'am_tuning_curve')


# exp1 = celldatabase.Experiment(subject, '2018-03-09', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
# exp2 = celldatabase.Experiment(subject, '2018-03-11', 'right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
# exp4 = celldatabase.Experiment(subject, '2018-03-19', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
