...
exp0 = celldatabase.Experiment(subject, '2016-09-16', 'left_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
exp0.add_site(1140, egroups=[2,4,6])
...
exp0.add_site(1270, egroups=[1,2,4,6])
...
exp0.add_site(1310, egroups=[1,2,3,4,6])
...
# exp1 = celldatabase.Experiment(subject, '2016-09-20', 'left_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
# }
#
# exp2 = celldatabase.Experiment(subject, '2016-09-21', 'left_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
