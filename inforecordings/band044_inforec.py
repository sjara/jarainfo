...
exp0 = celldatabase.Experiment(subject, '2018-01-09', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
# exp0.add_site(1350, egroups=[1,2,4,6,7,8])
# exp0.add_session('15-25-24', None, 'laserPulse', 'am_tuning_curve')
#
# exp0.add_site(1375, egroups=[1,2,4,5,7,8])
# exp0.add_session('15-28-57', None, 'laserPulse', 'am_tuning_curve')
#
# exp0.add_site(1400, egroups=[1,2,5,6,7,8])
# exp0.add_session('15-32-22', None, 'laserPulse', 'am_tuning_curve')

exp0.maxDepth = 1400


exp1 = celldatabase.Experiment(subject, '2018-01-10', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
exp2 = celldatabase.Experiment(subject, '2018-01-11', 'right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
exp2.add_site(1300, egroups=[1,2,4,6,7])
...
exp3 = celldatabase.Experiment(subject, '2018-01-12', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
# exp4.add_site(850, egroups=[2,4,6,8])
...
exp4.add_site(925, egroups=[2,4,6,8])
...
exp4.add_site(1125, egroups=[2,4,6,8])
...
exp5 = celldatabase.Experiment(subject, '2018-01-16', 'left_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_right'])
...
exp5.add_site(900, egroups=[1,2,4,5,6,7,8])
...
# exp5.add_site(1050, egroups=[1,2,4,5,6,7,8])
# exp5.add_session('18-23-25', None, 'laserPulse', 'am_tuning_curve')
#
# exp5.add_site(1075, egroups=[1,2,4,5,6,7,8])
# exp5.add_session('18-28-51', None, 'laserPulse', 'am_tuning_curve')

exp5.add_site(1100, egroups=[1,2,4,5,6,7,8])
