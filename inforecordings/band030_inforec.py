...
exp0 = celldatabase.Experiment(subject, '2017-06-05', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp1 = celldatabase.Experiment(subject, '2017-06-07', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
# exp1.add_site(1160, egroups = [2,3,4])
# exp1.add_session('11-43-03', None, 'laserPulse', 'am_tuning_curve')
#
# exp1.add_site(1180, egroups = [1,2,3,4,8])
...
exp2 = celldatabase.Experiment(subject, '2017-06-23', 'right_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
exp2.add_site(900, egroups=[1,2,3,4,6,8])
...
# exp2.add_site(950, egroups=[1,2,3,4,6,8])
# exp2.add_session('14-51-05', None, 'laserPulse', 'am_tuning_curve')

exp2.add_site(975, egroups=[1,2,3,4,6,8])
...
# exp3 = celldatabase.Experiment(subject, '2017-06-26', 'right_AC', probe='A4x2-tet', info=['lateralDiD','TT1ant','sound_left'])
