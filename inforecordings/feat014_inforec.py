...
exp3 = celldatabase.Experiment(subject, '2024-02-xx', brainArea='right_AC', probe='NPv1-4542', recordingTrack='posteriorlateral_DiD', info=['facesMedial', 'soundLeft']) # Reference = tip.
# Check sound location with Craniotomy
