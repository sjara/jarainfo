...
exp7 = celldatabase.Experiment(subject, '2024-03-18', brainArea='left_AC', probe='NPv1-4542', recordingTrack='anteriorCenter_DiI', info=['facesAnterior', 'soundRight']) # Reference = tip.
# Check sound location with Craniotomy
