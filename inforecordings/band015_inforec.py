...
# exp0 = celldatabase.Experiment(subject, '2016-11-08','right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
# exp0.add_site(950, egroups = [2])
# exp0.add_session('15-27-14', None, 'noisebursts', 'am_tuning_curve')
# exp0.add_session('15-30-37', None, 'laserPulse', 'am_tuning_curve')

exp1 = celldatabase.Experiment(subject, '2016-11-10', 'right_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
# exp1.add_site(1275, egroups = [2,6])
# exp1.add_session('14-43-39', None, 'noisebursts', 'am_tuning_curve')

exp1.add_site(1325, egroups = [2,6])
...
exp1.add_site(1400, egroups = [2,6,8])
...
exp2 = celldatabase.Experiment(subject, '2016-11-11', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp2.add_site(1000, egroups = [1,2,3,4,6,7,8])
...
exp2.add_site(1026, egroups = [1,2,4,6,7,8])
...
exp2.add_site(1100, egroups = [1,2,4,5,6,7,8])
...
exp3 = celldatabase.Experiment(subject, '2016-11-12', 'left_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
exp3.add_site(950, egroups = [2,4,6,8])
...
exp3.add_site(1000, egroups = [1,2,4,6,7,8])
...
exp3.add_site(1150, egroups = [1,2,3,4,6,7,8])
...
#
# exp3.add_site(1250, egroups = [1,2,3,4,6,7,8])
# exp3.add_session('14-21-33', None, 'laserPulse', 'am_tuning_curve')

exp3.add_site(1275, egroups = [1,2,3,4,6,7,8])
...
exp4 = celldatabase.Experiment(subject, '2016-11-13', 'left_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
exp4.add_site(1150, egroups = [1,2,3,4,5,6,8])
...
# exp4.add_site(1225, egroups = [1,2,3,4,5,6,8])
# exp4.add_session('15-15-59', None, 'laserPulse', 'am_tuning_curve')

exp4.add_site(1260, egroups = [1,2,3,4,6,7,8])
