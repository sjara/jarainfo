...
# 14:10 took the mouse out
# Reference electrode is 3:tip
# Targeting right pStr
# Probe is located in the center of craniotomy
# I zeroed the manipulator when I first touched dura-gel. Dura-gel was so clear that I could see when the probe tauched the brain surface, it was at 1102um.
...
# Shank 3 Bank A
#exp0.add_session('12-29-25', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp0.add_site(1840)
# Shank 3 Bank B
#exp0.add_session('12-32-18', 'f', 'tuningFreqLFP', 'am_tuning_curve') #40 trial
#-------------------------------------------------------------------------------------------------------
...
# Shank 3 Bank A
#exp1.add_session('11-48-21', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp1.add_site(1820) 
# Shank 3 Bank B
#exp1.add_session('11-50-23', 'f', 'tuningFreqLFP', 'am_tuning_curve') #43 trial
#-------------------------------------------------------------------------------------------------------
...
# Shank 3 Bank A
#exp2.add_session('13-40-52', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp2.add_site(1650) 
# Shank 3 Bank B
#exp2.add_session('13-43-00', 'f', 'tuningFreqLFP', 'am_tuning_curve') #43 trial
#-------------------------------------------------------------------------------------------------------
...
# Shank 3 Bank A
#exp3.add_session('10-42-16', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp3.add_site(1620) 
# Shank 3 Bank B
#exp3.add_session('10-44-25', 'f', 'tuningFreqLFP', 'am_tuning_curve') #43 trial
