...
# exp0 = celldatabase.Experiment(subject, '2017-10-04', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp1 = celldatabase.Experiment(subject, '2017-10-05', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
# exp2 = celldatabase.Experiment(subject, '2017-10-07', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
