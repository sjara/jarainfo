...
exp0 = celldatabase.Experiment(subject, '2017-05-22', 'right_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
exp0.add_site(1320, egroups = [1,2,3,4,6,7,8])
...
# exp1 = celldatabase.Experiment(subject, '2017-05-24', 'right_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
# exp2.add_site(1120, egroups = [1,2,4,6,8])
# exp2.add_session('12-44-48', None, 'laserPulse', 'am_tuning_curve')

exp2.add_site(1130, egroups = [1,2,3,4,6,7,8])
...
exp3 = celldatabase.Experiment(subject, '2017-05-26', 'right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
# exp4 = celldatabase.Experiment(subject, '2017-05-28', 'right_AC', probe='A4x2-tet', info=['posteriourmiddleDiD','TT1ant','sound_left'])
