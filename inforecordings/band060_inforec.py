...
# exp0 = celldatabase.Experiment(subject, '2018-03-29', 'right_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_left'])
...
# exp1.add_site(1250, egroups=[1,2,3,4,6,7,8])
# exp1.add_session('14-30-03', None, 'laserPulse', 'am_tuning_curve')

exp1.add_site(1275, egroups=[1,2,3,4,6,7,8])
...
# exp2 = celldatabase.Experiment(subject, '2018-04-03', 'right_AC', probe='A4x2-tet', info=['lateralDiD','TT1ant','sound_left'])
...
exp3 = celldatabase.Experiment(subject, '2018-04-03', 'left_AC', probe='A4x2-tet', info=['lateralDiD','TT1ant','sound_right'])
...
exp3.add_site(900, egroups=[2,4,5,6,7,8])
...
exp3.add_site(1100, egroups=[1,2,3,4,6,7,8])
...
# exp3.add_site(1200, egroups=[1,2,3,4,6,7,8])
# exp3.add_session('17-55-30', None, 'laserPulse', 'am_tuning_curve')

exp3.add_site(1225, egroups=[1,2,3,4,6,7,8])
...
exp4 = celldatabase.Experiment(subject, '2018-04-04', 'left_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_right'])
...
exp5 = celldatabase.Experiment(subject, '2018-04-05', 'left_AC', probe='A4x2-tet', info=['medialDiD','TT1ant','sound_right'])
