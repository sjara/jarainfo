...
exp0 = celldatabase.Experiment(subject, '2017-07-27', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp0.add_site(1700, egroups=[1,2,4,7,8])
...
exp1 = celldatabase.Experiment(subject, '2017-08-02', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
exp1.add_site(1260, egroups=[1,2,3,4,5,6,8])
...
# exp1.add_site(1300, egroups=[1,2,3,4,5,6,7,8])
# exp1.add_session('13-08-44', None, 'laserPulse', 'am_tuning_curve')

# exp1.add_site(1325, egroups=[1,2,3,4,5,6,7,8])
...
exp1.add_site(1350, egroups=[1,2,3,4,6,7,8])
...
# exp2.add_site(1150, egroups=[1,2,3,4,8])
...
exp2.add_site(1250, egroups=[1,2,3,4,5,7,8])
...
exp2.add_site(1300, egroups=[1,2,4,5,6,7,8])
...
exp3 = celldatabase.Experiment(subject, '2017-08-11', 'left_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_right'])
...
# exp3.add_site(900, egroups=[1,2,5,6,7,8])
# exp3.add_session('11-49-56', None, 'laserPulse', 'am_tuning_curve')
#
# exp3.add_site(950, egroups=[1,2,4,5,6,7,8])
# exp3.add_session('11-54-54', None, 'laserPulse', 'am_tuning_curve')
#
# exp3.add_site(975, egroups=[1,2,4,5,6,7,8])
