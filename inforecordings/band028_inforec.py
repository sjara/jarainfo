...
exp0 = celldatabase.Experiment(subject, '2017-05-18', 'right_AC', probe='A4x2-tet', info=['middleDiI','TT1ant','sound_left'])
...
exp0.add_site(1258, egroups = [2,4,6,8])
...
# exp0.add_site(1411, egroups = [2,4,5,6,8])
# exp0.add_session('12-14-52', None, 'laserPulse', 'am_tuning_curve')
#
# exp0.add_site(1504, egroups = [1,2,4,5,6,8])
# exp0.add_session('12-18-30', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(1550, egroups = [1,2,3,4,5,6,8])
...
#
# exp1 = celldatabase.Experiment(subject, '2017-05-19', 'right_AC', probe='A4x2-tet', info=['lateralDiD','TT1ant','sound_left'])
...
# exp1.add_site(1791, egroups = [1,4,5,6,7])
# exp1.add_session('15-06-06', None, 'laserPulse', 'am_tuning_curve')
#
# exp1.add_site(1782, egroups = [1,4,5,6,7])
# exp1.add_session('15-09-18', None, 'laserPulse', 'am_tuning_curve')
#
# exp1.add_site(1561, egroups = [2,4,5,6,7])
# exp1.add_session('15-20-29', None, 'laserPulse', 'am_tuning_curve')


exp2 = celldatabase.Experiment(subject, '2017-05-20', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp2.add_site(1325, egroups = [1,2,3,4,6,7,8])
...
exp3 = celldatabase.Experiment(subject, '2017-05-21', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
