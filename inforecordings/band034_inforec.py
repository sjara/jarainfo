...
# exp0 = celldatabase.Experiment(subject, '2017-08-30', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp1.add_site(1250, egroups=[2,4,5,6])
...
exp2 = celldatabase.Experiment(subject, '2017-09-01', 'left_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_right'])
...
# exp2.add_site(1100, egroups=[1,2,3,4,6])
# exp2.add_session('15-51-46', None, 'laserPulse', 'am_tuning_curve')
#
# exp2.add_site(1150, egroups=[1,2,3,4,5,6])
# exp2.add_session('15-56-52', None, 'laserPulse', 'am_tuning_curve')


########## FIX ME #############
"""
# NOTE: Santiago had to change depth to 1176 (from 1175) to avoid
#       confusion with another penetration on the same day at 1175.
exp2.add_site(1176, egroups=[1,2,3,4,6])
