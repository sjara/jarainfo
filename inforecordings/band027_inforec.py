...
# exp0 = celldatabase.Experiment(subject, '2017-05-03', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
exp1 = celldatabase.Experiment(subject, '2017-05-05', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
# exp1.add_site(1282, egroups = [2,4,6,8])
# exp1.add_session('10-32-01', None, 'laserPulse', 'am_tuning_curve')

exp1.add_site(1289, egroups = [2,4,6,8])
...
# exp2.add_site(1653, egroups = [2,4,6,8])
# exp2.add_session('14-43-43', None, 'laserPulse', 'am_tuning_curve')
#
# exp2.add_site(1734, egroups = [2,4,6,7,8])
# exp2.add_session('14-47-50', None, 'laserPulse', 'am_tuning_curve')
#
# exp2.add_site(1765, egroups = [1,2,3,4,6,7,8])
# exp2.add_session('14-51-38', None, 'laserPulse', 'am_tuning_curve')

exp2.maxDepth = 1765


exp3 = celldatabase.Experiment(subject, '2017-05-07', 'right_AC', probe='A4x2-tet', info=['posteriormedialDiD','TT1ant','sound_left'])
...
# exp3.add_site(1226, egroups = [2,4,6,8])
# exp3.add_session('12-46-51', None, 'laserPulse', 'am_tuning_curve')

exp3.add_site(1233, egroups = [2,4,6,7,8])
...
# exp4 = celldatabase.Experiment(subject, '2017-05-08', 'right_AC', probe='A4x2-tet', info=['posteriorlateralDiI','TT1ant','sound_left'])
