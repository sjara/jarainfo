...
# Shank 1 Bank A
#exp0.add_session('16-34-35', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp0.add_site(1120) 
# Shank 1 Bank B
#exp0.add_session('16-36-07', 'f', 'tuningFreqLFP', 'am_tuning_curve') #40 trials
...
# Shank 1 Bank A
#exp1.add_session('15-46-40', 'e', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp1.add_site(1520)
# Shank 1 Bank B
#exp1.add_session('15-49-04', 'f', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp1.maxDepth = 4400
#-------------------------------------------------------------------------------------------------------

#According to the histology, this penetration could have hit the pStr
#2026-02-09
...
# Shank 1 Bank A
#exp2.add_session('15-58-26', 'h', 'tuningFreqLFP', 'am_tuning_curve') #41 trials
...
# Shank 1 Bank A
#exp3.add_session('16-19-40', 'i', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp3.add_site(1320)
# Shank 1 Bank B
#exp3.add_session('16-22-44', 'j', 'tuningFreqLFP', 'am_tuning_curve') #40 trials
