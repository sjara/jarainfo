...
exp0 = celldatabase.Experiment(subject, '2017-07-14', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
# exp0.add_site(850, egroups=[2,3,4,5,6,7,8])
...
#
# exp0.add_site(900, egroups=[2,3,4,5,6,8])
# exp0.add_session('13-35-27', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(950, egroups=[2,3,4,5,6,8])
...
# exp0.add_site(1200, egroups = [2,3,4,6])
# exp0.add_session('15-36-47', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(1225, egroups = [2,3,4,6])
...
exp1 = celldatabase.Experiment(subject, '2017-07-17', 'left_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_right'])
...
exp3 = celldatabase.Experiment(subject, '2017-07-21', 'left_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_right'])
...
#
# exp3.add_site(1150, egroups = [1,2,4,6,7,8])
# exp3.add_session('15-18-03', None, 'laserPulse', 'am_tuning_curve')
#
# exp3.add_site(1175, egroups = [1,2,4,6,7,8])
...
# exp3.add_site(1275, egroups = [1,2,4,6,7,8])
# exp3.add_session('16-19-55', None, 'laserPulse', 'am_tuning_curve')

exp3.add_site(1300, egroups = [1,2,4,6,7,8])
...
# exp4 = celldatabase.Experiment(subject, '2017-07-23', 'left_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_right'])
