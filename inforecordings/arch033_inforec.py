...
#-------------------------------------------------------------------------------------------------------
#We saw from the histology that this penetration landed in the white matter border with the cortex (Didn't hit the pStr)
...
# Shank 1 Bank A
#exp0.add_session('17-15-55', 'a', 'tuningFreqLFP', 'am_tuning_curve') #40 trials

#exp0.add_site(620) 
# Shank 1 Bank B
#exp0.add_session('17-26-03', 'b', 'tuningFreqLFP', 'am_tuning_curve') #40 trials
...
# Shank 1 Bank A
#exp1.add_session('13-21-17', 'c', 'tuningFreqLFP', 'am_tuning_curve') #40 trials
