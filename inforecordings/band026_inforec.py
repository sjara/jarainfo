...
exp0 = celldatabase.Experiment(subject, '2017-04-26', 'right_AC', probe='A4x2-tet', info=['medialDiI','TT1ant','sound_left'])
...
# exp0.add_site(850, egroups = [4,7,8])
...
#
# exp0.add_site(1010, egroups = [4,5,6,8])
# exp0.add_session('11-05-16', None, 'noisebursts', 'am_tuning_curve')

exp0.add_site(1096, egroups = [4,5,6,7,8])
...
# exp0.add_site(1322, egroups = [4,6,7,8])
...
exp0.add_site(1470, egroups = [4,5,6,7,8])
...
exp1 = celldatabase.Experiment(subject, '2017-04-27', 'right_AC', probe='A4x2-tet', info=['middleDiD','TT1ant','sound_left'])
...
exp1.add_site(1190, egroups = [4,6,7,8])
...
# exp1.add_site(1310, egroups = [4,6,8])
...
exp1.add_site(1350, egroups = [4,6,8])
...
exp1.add_site(1410, egroups = [4,6,8])
...
exp2 = celldatabase.Experiment(subject, '2017-04-28', 'right_AC', probe='A4x2-tet', info=['lateralDiI','TT1ant','sound_left'])
...
exp2.add_site(1160, egroups = [4,6,8])
...
exp2.add_site(1220, egroups = [4,6,8])
...
exp2.add_site(1304, egroups = [4,6,8])
...
exp3 = celldatabase.Experiment(subject, '2017-04-29', 'right_AC', probe='A4x2-tet', info=['posteriormiddleDiI','TT1ant','sound_left'])
...
exp3.add_site(1060, egroups = [4,6,8])
...
exp3.add_site(1240, egroups = [4,6,7,8])
...
exp3.add_site(1387, egroups = [4,6,8])
...
exp4 = celldatabase.Experiment(subject, '2017-04-30', 'right_AC', probe='A4x2-tet', info=['posteriorlateralDiD','TT1ant','sound_left'])
...
exp4.add_site(1370, egroups = [4,6,8])
...
exp4.add_site(1500, egroups = [4,8])
